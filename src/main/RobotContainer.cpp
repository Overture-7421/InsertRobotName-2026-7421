...
RobotContainer::RobotContainer() {
	...
	pathplanner::NamedCommands::registerCommand("LaunchCommand", std::move(LaunchCommand(&shooter, &hood, &chassis, &launchModeManager, [this] {return launchShooterMulti;}, &driver, &intake, &processor)).WithTimeout(4.5_s));
