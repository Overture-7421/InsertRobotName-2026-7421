...
#else
	config.EncoderConfig.Offset = -0.034423828125_tr;
#endif 
...
SwerveModuleConfig Chassis::BackRightConfig() {
	...
	config.EncoderConfig.Offset = 0.0_tr;
#else
	config.EncoderConfig.Offset = -0.149658203125_tr;
#endif 
	config.TurnMotorConfig.PIDConfigs.WithKP(40).WithKS(0.15);
	config.TurnMotorConfig.Inverted = false;
	config.DriveMotorConfig.Inverted = false;
...
SwerveModuleConfig Chassis::FrontLeftConfig() {
	...
	config.EncoderConfig.Offset = 0.0_tr;
#else
	config.EncoderConfig.Offset = -0.12255859375_tr;
#endif
	config.TurnMotorConfig.PIDConfigs.WithKP(40).WithKS(0.15);
	config.TurnMotorConfig.Inverted = false;
	config.DriveMotorConfig.Inverted = false;
...
SwerveModuleConfig Chassis::BackLeftConfig() {
	...
	config.EncoderConfig.Offset = 0.0_tr;
#else
	config.EncoderConfig.Offset = -0.383056640625_tr;
#endif 
	config.TurnMotorConfig.PIDConfigs.WithKP(40).WithKS(0.15);
	config.TurnMotorConfig.Inverted = false;
	config.DriveMotorConfig.Inverted = false;
